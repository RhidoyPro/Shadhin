...
export const NudgeEmail = ({ name, stateName }: NudgeEmailProps) => (
  <Html>
    <Head />
    <Preview>Have you tried posting on Shadhin.io?</Preview>
    <Body style={main}>
      <Container style={container}>
        <Text style={logo}>Shadhin.io</Text>
        <Heading style={heading}>Hey {name}, your district is waiting!</Heading>
        <Text style={paragraph}>
          You joined 3 days ago but haven't posted yet. Your {stateName} community
          would love to hear from you.
        </Text>
        <Text style={paragraph}>
          Share a quick update, ask a question, or tell people about an upcoming event.
        </Text>
